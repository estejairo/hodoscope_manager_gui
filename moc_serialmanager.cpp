...
QT_MOC_LITERAL(5, 44, 8)
    ...
    "SerialManager\0dataRead\0\0sendParams\0"
    "readData\0sendData"
};
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialManager::dataRead)) {
                *result = 0;
            }
        }
        {
            typedef void (SerialManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialManager::sendParams)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void SerialManager::dataRead(QByteArray _t1)
{
