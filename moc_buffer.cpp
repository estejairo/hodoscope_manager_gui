...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Buffer_t, stringdata) + ofs \
...
const QMetaObject Buffer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Buffer.data,
      qt_meta_data_Buffer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Buffer.stringdata))
